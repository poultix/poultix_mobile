...
// import DeviceInfo from 'react-native-device-info'; // Removed to fix native module error
    ...
    const requestPermissions = async () => {
        try {
            if (Platform.OS === 'android') {
                const apiLevel = Platform.Version as number; // Use Platform.Version instead of DeviceInfo
